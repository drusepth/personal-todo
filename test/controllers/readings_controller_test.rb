...
class ReadingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reading" do
    assert_difference('Reading.count') do
      post readings_url, params: { reading: { link: @reading.link, notes: @reading.notes, project_id: @reading.project_id, read_at: @reading.read_at, title: @reading.title } }
    end
  ...
  test "should update reading" do
    patch reading_url(@reading), params: { reading: { link: @reading.link, notes: @reading.notes, project_id: @reading.project_id, read_at: @reading.read_at, title: @reading.title } }
