class ReadingsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @reading.update(reading_params)
        format.html { redirect_to root_path, notice: 'Reading was successfully updated.' }
  ...
  def destroy
    @reading.destroy
    respond_to do |format|
      format.html { redirect_to root_path, notice: 'Reading was successfully destroyed.' }
  ...
  private
    ...
    def reading_params
      params.require(:reading).permit(:title, :link, :project_id, :read_at, :notes)
    end
end
